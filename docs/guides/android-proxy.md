...
Your agent will suggest this if you try to install a cert on a non-rootable device — it'll even tell you the exact `sdkmanager` and `avdmanager` commands to create one.
